...
.data
	...
	arr: .byte 0B0011100, 0B0011001, 0B0010101, 0B0001101, 0B0011100, 0B0011001, 0B0010101, 0B0001101
...
//TODO: Display 0 to F at first digit on 7-SEG LED.
	PUSH {LR}
	MOVS R4, #0///R4 IS OUTER LOOP INDEX
	LDR R5, =arr
DD_LOOP:
	MOVS R6, #0///R6 IS INNER LOOP INDEX
DD_LOOP2:
...
SKIP:
	...
	ADDS R6, #1
	CMP R6, #8
	BLT DD_LOOP2///END OF DD_LOOP2

	BL Delay
	ADDS R4, #1
	CMP R4, #8
	BLT DD_LOOP///END OF DD_LOOP
